function MakeSlideShowNew(params) {
    ...
    {
        if (count === 0){
            myImage.style.border = "8px inset black";
            myImage.style.borderRadius = "50%";
            count++;
        }
        else if (count === 1){
            myImage.style.border = "20px inset red";
            myImage.style.borderRadius = "20px";
            count++;
        }
        else if (count === 2){
            myImage.style.border = "10px inset green";
            myImage.style.borderRadius = "0px";
            count++;
        }
        else{
            myImage.style.border = "3px inset gold";
    ...
    propButton.onclick = changeProperties;
